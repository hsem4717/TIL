...
2.private 접근 제한은 상속 대상에서 제외, 다른패키지라면 default도 제외 3.메소드가 자식클래스에게 적합하지 않을 경우 메소드 재정의가 필요

<h3>메소드 재정의</h3>

규칙<p> 1.부모의 메소드와 동일한 시그니처를 가져야함 2.접근 제한을 더 강하게 재정의 불가 3.새로운 예외를 thorws 불가
